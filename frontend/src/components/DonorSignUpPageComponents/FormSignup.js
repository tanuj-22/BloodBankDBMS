      ...
      <div className={classes.paper}>
        ...
        <form className={classes.form} onSubmit={handleSubmit} noValidate>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6}>
              <label htmlFor="blood_group" className="form-label"></label>
              ...
              <Typography variant="caption">
                {errors.blood_group && (
                  <p style={{ color: "red" }}>{errors.blood_group}</p>
                )}
              </Typography>
            </Grid>

            <Grid item xs={12}>
              <label htmlFor="disease" className="form-label"></label>
          ...
          <Grid item xs={12}>
            <label htmlFor="primaryAddress" className="form-label"></label>
            ...
            <Typography variant="caption">
              {errors.primaryAddress && (
                <p style={{ color: "red" }}>{errors.primaryAddress}</p>
              )}
            </Typography>
          </Grid>
          {/* <Grid item xs={12}>
          ...
          <Grid item xs={12}>
            <label htmlFor="Aadhar_no" className="form-label"></label>
